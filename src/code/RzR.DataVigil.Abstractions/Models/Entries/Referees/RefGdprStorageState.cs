...
// ***********************************************************************
//  <copyright file="RefGdprStorageState.cs" company="RzR SOFT & TECH">
...
namespace RzR.DataVigil.Abstractions.Models.Entries.Referees
{
    ...
    ///     <see cref="T:RzR.DataVigil.Abstractions.Enums.GdprStorageState"/> member.
    /// </summary>
    /// =================================================================================================
    public class RefGdprStorageState
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
