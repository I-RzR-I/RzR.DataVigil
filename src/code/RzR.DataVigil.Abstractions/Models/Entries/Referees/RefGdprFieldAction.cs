...
// ***********************************************************************
//  <copyright file="RefGdprFieldAction.cs" company="RzR SOFT & TECH">
...
namespace RzR.DataVigil.Abstractions.Models.Entries.Referees
{
    ...
    ///     <see cref="T:RzR.DataVigil.Abstractions.Enums.GdprFieldAction"/> member.
    /// </summary>
    /// =================================================================================================
    public class RefGdprFieldAction
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
