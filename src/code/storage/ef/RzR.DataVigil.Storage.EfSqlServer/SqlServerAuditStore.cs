...
// ***********************************************************************
//  <copyright file="SqlServerAuditStore.cs" company="RzR SOFT & TECH">
...
namespace RzR.DataVigil.Storage.EfSqlServer
{
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    ///     SQL Server implementation of <see cref="IAuditStore"/> using EF Core.
    ///     Persists audit transactions to a SQL Server database and supports pagination,
    ...
    public class SqlServerAuditStore : IAuditStore
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     (Immutable) the SQL Server audit database context.
        /// </summary>
        /// =================================================================================================
        private readonly AuditSqlServerDbContext _dbContext;
        ...
        /// </summary>
        /// <param name="dbContext">The SQL Server audit database context.</param>
        ...
        public SqlServerAuditStore(
            AuditSqlServerDbContext dbContext,
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     Persists an audit transaction to the SQL Server database.
