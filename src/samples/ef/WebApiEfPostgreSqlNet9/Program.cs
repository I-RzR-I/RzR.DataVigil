...
using WebApiEfPostgreSqlNet9.Extensions;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApiEfPostgreSqlNet9", Version = "v1" });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebApiEfPostgreSqlNet9 v1"));
}
