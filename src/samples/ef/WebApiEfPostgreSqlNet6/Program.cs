...
using WebApiEfPostgreSqlNet6.Data;
using WebApiEfPostgreSqlNet6.Extensions;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApiEfPostgreSqlNet6", Version = "v1" });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebApiEfPostgreSqlNet6 v1"));
}
