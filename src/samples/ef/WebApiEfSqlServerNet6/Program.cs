...
using WebApiEfSqlServerNet6.Extensions;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApiEfSqlServerNet6", Version = "v1" });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebApiEfSqlServerNet6 v1"));
}
